...
export enum AuditAction {
  ...
  MARKET_THAWED = 'MARKET_THAWED',
  MARKET_ARCHIVED = 'MARKET_ARCHIVED',
  MARKET_REGIONS_UPDATED = 'MARKET_REGIONS_UPDATED',
  MARKET_TRADING_ENABLED = 'MARKET_TRADING_ENABLED',
  MARKET_TRADING_DISABLED = 'MARKET_TRADING_DISABLED',
